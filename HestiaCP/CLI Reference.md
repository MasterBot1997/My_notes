<details><summary>Все команды ссылками на доку</summary>

- [v-acknowledge-user-notification](https://hestiacp.com/docs/reference/cli.html#v-acknowledge-user-notification "v-acknowledge-user-notification")
- [v-add-access-key](https://hestiacp.com/docs/reference/cli.html#v-add-access-key "v-add-access-key")
- [v-add-backup-host](https://hestiacp.com/docs/reference/cli.html#v-add-backup-host "v-add-backup-host")
- [v-add-cron-hestia-autoupdate](https://hestiacp.com/docs/reference/cli.html#v-add-cron-hestia-autoupdate "v-add-cron-hestia-autoupdate")
- [v-add-cron-job](https://hestiacp.com/docs/reference/cli.html#v-add-cron-job "v-add-cron-job")
- [v-add-cron-letsencrypt-job](https://hestiacp.com/docs/reference/cli.html#v-add-cron-letsencrypt-job "v-add-cron-letsencrypt-job")
- [v-add-cron-reports](https://hestiacp.com/docs/reference/cli.html#v-add-cron-reports "v-add-cron-reports")
- [v-add-cron-restart-job](https://hestiacp.com/docs/reference/cli.html#v-add-cron-restart-job "v-add-cron-restart-job")
- [v-add-database](https://hestiacp.com/docs/reference/cli.html#v-add-database "v-add-database")
- [v-add-database-host](https://hestiacp.com/docs/reference/cli.html#v-add-database-host "v-add-database-host")
- [v-add-database-temp-user](https://hestiacp.com/docs/reference/cli.html#v-add-database-temp-user "v-add-database-temp-user")
- [v-add-dns-domain](https://hestiacp.com/docs/reference/cli.html#v-add-dns-domain "v-add-dns-domain")
- [v-add-dns-on-web-alias](https://hestiacp.com/docs/reference/cli.html#v-add-dns-on-web-alias "v-add-dns-on-web-alias")
- [v-add-dns-record](https://hestiacp.com/docs/reference/cli.html#v-add-dns-record "v-add-dns-record")
- [v-add-domain](https://hestiacp.com/docs/reference/cli.html#v-add-domain "v-add-domain")
- [v-add-fastcgi-cache](https://hestiacp.com/docs/reference/cli.html#v-add-fastcgi-cache "v-add-fastcgi-cache")
- [v-add-firewall-ban](https://hestiacp.com/docs/reference/cli.html#v-add-firewall-ban "v-add-firewall-ban")
- [v-add-firewall-chain](https://hestiacp.com/docs/reference/cli.html#v-add-firewall-chain "v-add-firewall-chain")
- [v-add-firewall-ipset](https://hestiacp.com/docs/reference/cli.html#v-add-firewall-ipset "v-add-firewall-ipset")
- [v-add-firewall-rule](https://hestiacp.com/docs/reference/cli.html#v-add-firewall-rule "v-add-firewall-rule")
- [v-add-fs-archive](https://hestiacp.com/docs/reference/cli.html#v-add-fs-archive "v-add-fs-archive")
- [v-add-fs-directory](https://hestiacp.com/docs/reference/cli.html#v-add-fs-directory "v-add-fs-directory")
- [v-add-fs-file](https://hestiacp.com/docs/reference/cli.html#v-add-fs-file "v-add-fs-file")
- [v-add-letsencrypt-domain](https://hestiacp.com/docs/reference/cli.html#v-add-letsencrypt-domain "v-add-letsencrypt-domain")
- [v-add-letsencrypt-host](https://hestiacp.com/docs/reference/cli.html#v-add-letsencrypt-host "v-add-letsencrypt-host")
- [v-add-letsencrypt-user](https://hestiacp.com/docs/reference/cli.html#v-add-letsencrypt-user "v-add-letsencrypt-user")
- [v-add-mail-account](https://hestiacp.com/docs/reference/cli.html#v-add-mail-account "v-add-mail-account")
- [v-add-mail-account-alias](https://hestiacp.com/docs/reference/cli.html#v-add-mail-account-alias "v-add-mail-account-alias")
- [v-add-mail-account-autoreply](https://hestiacp.com/docs/reference/cli.html#v-add-mail-account-autoreply "v-add-mail-account-autoreply")
- [v-add-mail-account-forward](https://hestiacp.com/docs/reference/cli.html#v-add-mail-account-forward "v-add-mail-account-forward")
- [v-add-mail-account-fwd-only](https://hestiacp.com/docs/reference/cli.html#v-add-mail-account-fwd-only "v-add-mail-account-fwd-only")
- [v-add-mail-domain](https://hestiacp.com/docs/reference/cli.html#v-add-mail-domain "v-add-mail-domain")
- [v-add-mail-domain-antispam](https://hestiacp.com/docs/reference/cli.html#v-add-mail-domain-antispam "v-add-mail-domain-antispam")
- [v-add-mail-domain-antivirus](https://hestiacp.com/docs/reference/cli.html#v-add-mail-domain-antivirus "v-add-mail-domain-antivirus")
- [v-add-mail-domain-catchall](https://hestiacp.com/docs/reference/cli.html#v-add-mail-domain-catchall "v-add-mail-domain-catchall")
- [v-add-mail-domain-dkim](https://hestiacp.com/docs/reference/cli.html#v-add-mail-domain-dkim "v-add-mail-domain-dkim")
- [v-add-mail-domain-reject](https://hestiacp.com/docs/reference/cli.html#v-add-mail-domain-reject "v-add-mail-domain-reject")
- [v-add-mail-domain-smtp-relay](https://hestiacp.com/docs/reference/cli.html#v-add-mail-domain-smtp-relay "v-add-mail-domain-smtp-relay")
- [v-add-mail-domain-ssl](https://hestiacp.com/docs/reference/cli.html#v-add-mail-domain-ssl "v-add-mail-domain-ssl")
- [v-add-mail-domain-webmail](https://hestiacp.com/docs/reference/cli.html#v-add-mail-domain-webmail "v-add-mail-domain-webmail")
- [v-add-remote-dns-domain](https://hestiacp.com/docs/reference/cli.html#v-add-remote-dns-domain "v-add-remote-dns-domain")
- [v-add-remote-dns-host](https://hestiacp.com/docs/reference/cli.html#v-add-remote-dns-host "v-add-remote-dns-host")
- [v-add-remote-dns-record](https://hestiacp.com/docs/reference/cli.html#v-add-remote-dns-record "v-add-remote-dns-record")
- [v-add-sys-api-ip](https://hestiacp.com/docs/reference/cli.html#v-add-sys-api-ip "v-add-sys-api-ip")
- [v-add-sys-dependencies](https://hestiacp.com/docs/reference/cli.html#v-add-sys-dependencies "v-add-sys-dependencies")
- [v-add-sys-filemanager](https://hestiacp.com/docs/reference/cli.html#v-add-sys-filemanager "v-add-sys-filemanager")
- [v-add-sys-firewall](https://hestiacp.com/docs/reference/cli.html#v-add-sys-firewall "v-add-sys-firewall")
- [v-add-sys-ip](https://hestiacp.com/docs/reference/cli.html#v-add-sys-ip "v-add-sys-ip")
- [v-add-sys-pma-sso](https://hestiacp.com/docs/reference/cli.html#v-add-sys-pma-sso "v-add-sys-pma-sso")
- [v-add-sys-quota](https://hestiacp.com/docs/reference/cli.html#v-add-sys-quota "v-add-sys-quota")
- [v-add-sys-roundcube](https://hestiacp.com/docs/reference/cli.html#v-add-sys-roundcube "v-add-sys-roundcube")
- [v-add-sys-sftp-jail](https://hestiacp.com/docs/reference/cli.html#v-add-sys-sftp-jail "v-add-sys-sftp-jail")
- [v-add-sys-smtp](https://hestiacp.com/docs/reference/cli.html#v-add-sys-smtp "v-add-sys-smtp")
- [v-add-sys-smtp-relay](https://hestiacp.com/docs/reference/cli.html#v-add-sys-smtp-relay "v-add-sys-smtp-relay")
- [v-add-sys-snappymail](https://hestiacp.com/docs/reference/cli.html#v-add-sys-snappymail "v-add-sys-snappymail")
- [v-add-sys-web-terminal](https://hestiacp.com/docs/reference/cli.html#v-add-sys-web-terminal "v-add-sys-web-terminal")
- [v-add-user](https://hestiacp.com/docs/reference/cli.html#v-add-user "v-add-user")
- [v-add-user-2fa](https://hestiacp.com/docs/reference/cli.html#v-add-user-2fa "v-add-user-2fa")
- [v-add-user-composer](https://hestiacp.com/docs/reference/cli.html#v-add-user-composer "v-add-user-composer")
- [v-add-user-notification](https://hestiacp.com/docs/reference/cli.html#v-add-user-notification "v-add-user-notification")
- [v-add-user-package](https://hestiacp.com/docs/reference/cli.html#v-add-user-package "v-add-user-package")
- [v-add-user-sftp-jail](https://hestiacp.com/docs/reference/cli.html#v-add-user-sftp-jail "v-add-user-sftp-jail")
- [v-add-user-sftp-key](https://hestiacp.com/docs/reference/cli.html#v-add-user-sftp-key "v-add-user-sftp-key")
- [v-add-user-ssh-key](https://hestiacp.com/docs/reference/cli.html#v-add-user-ssh-key "v-add-user-ssh-key")
- [v-add-user-wp-cli](https://hestiacp.com/docs/reference/cli.html#v-add-user-wp-cli "v-add-user-wp-cli")
- [v-add-web-domain](https://hestiacp.com/docs/reference/cli.html#v-add-web-domain "v-add-web-domain")
- [v-add-web-domain-alias](https://hestiacp.com/docs/reference/cli.html#v-add-web-domain-alias "v-add-web-domain-alias")
- [v-add-web-domain-allow-users](https://hestiacp.com/docs/reference/cli.html#v-add-web-domain-allow-users "v-add-web-domain-allow-users")
- [v-add-web-domain-backend](https://hestiacp.com/docs/reference/cli.html#v-add-web-domain-backend "v-add-web-domain-backend")
- [v-add-web-domain-ftp](https://hestiacp.com/docs/reference/cli.html#v-add-web-domain-ftp "v-add-web-domain-ftp")
- [v-add-web-domain-httpauth](https://hestiacp.com/docs/reference/cli.html#v-add-web-domain-httpauth "v-add-web-domain-httpauth")
- [v-add-web-domain-proxy](https://hestiacp.com/docs/reference/cli.html#v-add-web-domain-proxy "v-add-web-domain-proxy")
- [v-add-web-domain-redirect](https://hestiacp.com/docs/reference/cli.html#v-add-web-domain-redirect "v-add-web-domain-redirect")
- [v-add-web-domain-ssl](https://hestiacp.com/docs/reference/cli.html#v-add-web-domain-ssl "v-add-web-domain-ssl")
- [v-add-web-domain-ssl-force](https://hestiacp.com/docs/reference/cli.html#v-add-web-domain-ssl-force "v-add-web-domain-ssl-force")
- [v-add-web-domain-ssl-hsts](https://hestiacp.com/docs/reference/cli.html#v-add-web-domain-ssl-hsts "v-add-web-domain-ssl-hsts")
- [v-add-web-domain-ssl-preset](https://hestiacp.com/docs/reference/cli.html#v-add-web-domain-ssl-preset "v-add-web-domain-ssl-preset")
- [v-add-web-domain-stats](https://hestiacp.com/docs/reference/cli.html#v-add-web-domain-stats "v-add-web-domain-stats")
- [v-add-web-domain-stats-user](https://hestiacp.com/docs/reference/cli.html#v-add-web-domain-stats-user "v-add-web-domain-stats-user")
- [v-add-web-php](https://hestiacp.com/docs/reference/cli.html#v-add-web-php "v-add-web-php")
- [v-backup-user](https://hestiacp.com/docs/reference/cli.html#v-backup-user "v-backup-user")
- [v-backup-users](https://hestiacp.com/docs/reference/cli.html#v-backup-users "v-backup-users")
- [v-change-cron-job](https://hestiacp.com/docs/reference/cli.html#v-change-cron-job "v-change-cron-job")
- [v-change-database-host-password](https://hestiacp.com/docs/reference/cli.html#v-change-database-host-password "v-change-database-host-password")
- [v-change-database-owner](https://hestiacp.com/docs/reference/cli.html#v-change-database-owner "v-change-database-owner")
- [v-change-database-password](https://hestiacp.com/docs/reference/cli.html#v-change-database-password "v-change-database-password")
- [v-change-database-user](https://hestiacp.com/docs/reference/cli.html#v-change-database-user "v-change-database-user")
- [v-change-dns-domain-dnssec](https://hestiacp.com/docs/reference/cli.html#v-change-dns-domain-dnssec "v-change-dns-domain-dnssec")
- [v-change-dns-domain-exp](https://hestiacp.com/docs/reference/cli.html#v-change-dns-domain-exp "v-change-dns-domain-exp")
- [v-change-dns-domain-ip](https://hestiacp.com/docs/reference/cli.html#v-change-dns-domain-ip "v-change-dns-domain-ip")
- [v-change-dns-domain-soa](https://hestiacp.com/docs/reference/cli.html#v-change-dns-domain-soa "v-change-dns-domain-soa")
- [v-change-dns-domain-tpl](https://hestiacp.com/docs/reference/cli.html#v-change-dns-domain-tpl "v-change-dns-domain-tpl")
- [v-change-dns-domain-ttl](https://hestiacp.com/docs/reference/cli.html#v-change-dns-domain-ttl "v-change-dns-domain-ttl")
- [v-change-dns-record](https://hestiacp.com/docs/reference/cli.html#v-change-dns-record "v-change-dns-record")
- [v-change-dns-record-id](https://hestiacp.com/docs/reference/cli.html#v-change-dns-record-id "v-change-dns-record-id")
- [v-change-domain-owner](https://hestiacp.com/docs/reference/cli.html#v-change-domain-owner "v-change-domain-owner")
- [v-change-firewall-rule](https://hestiacp.com/docs/reference/cli.html#v-change-firewall-rule "v-change-firewall-rule")
- [v-change-fs-file-permission](https://hestiacp.com/docs/reference/cli.html#v-change-fs-file-permission "v-change-fs-file-permission")
- [v-change-mail-account-password](https://hestiacp.com/docs/reference/cli.html#v-change-mail-account-password "v-change-mail-account-password")
- [v-change-mail-account-quota](https://hestiacp.com/docs/reference/cli.html#v-change-mail-account-quota "v-change-mail-account-quota")
- [v-change-mail-account-rate-limit](https://hestiacp.com/docs/reference/cli.html#v-change-mail-account-rate-limit "v-change-mail-account-rate-limit")
- [v-change-mail-domain-catchall](https://hestiacp.com/docs/reference/cli.html#v-change-mail-domain-catchall "v-change-mail-domain-catchall")
- [v-change-mail-domain-rate-limit](https://hestiacp.com/docs/reference/cli.html#v-change-mail-domain-rate-limit "v-change-mail-domain-rate-limit")
- [v-change-mail-domain-sslcert](https://hestiacp.com/docs/reference/cli.html#v-change-mail-domain-sslcert "v-change-mail-domain-sslcert")
- [v-change-remote-dns-domain-exp](https://hestiacp.com/docs/reference/cli.html#v-change-remote-dns-domain-exp "v-change-remote-dns-domain-exp")
- [v-change-remote-dns-domain-soa](https://hestiacp.com/docs/reference/cli.html#v-change-remote-dns-domain-soa "v-change-remote-dns-domain-soa")
- [v-change-remote-dns-domain-ttl](https://hestiacp.com/docs/reference/cli.html#v-change-remote-dns-domain-ttl "v-change-remote-dns-domain-ttl")
- [v-change-sys-api](https://hestiacp.com/docs/reference/cli.html#v-change-sys-api "v-change-sys-api")
- [v-change-sys-config-value](https://hestiacp.com/docs/reference/cli.html#v-change-sys-config-value "v-change-sys-config-value")
- [v-change-sys-db-alias](https://hestiacp.com/docs/reference/cli.html#v-change-sys-db-alias "v-change-sys-db-alias")
- [v-change-sys-demo-mode](https://hestiacp.com/docs/reference/cli.html#v-change-sys-demo-mode "v-change-sys-demo-mode")
- [v-change-sys-hestia-ssl](https://hestiacp.com/docs/reference/cli.html#v-change-sys-hestia-ssl "v-change-sys-hestia-ssl")
- [v-change-sys-hostname](https://hestiacp.com/docs/reference/cli.html#v-change-sys-hostname "v-change-sys-hostname")
- [v-change-sys-ip-name](https://hestiacp.com/docs/reference/cli.html#v-change-sys-ip-name "v-change-sys-ip-name")
- [v-change-sys-ip-nat](https://hestiacp.com/docs/reference/cli.html#v-change-sys-ip-nat "v-change-sys-ip-nat")
- [v-change-sys-ip-owner](https://hestiacp.com/docs/reference/cli.html#v-change-sys-ip-owner "v-change-sys-ip-owner")
- [v-change-sys-ip-status](https://hestiacp.com/docs/reference/cli.html#v-change-sys-ip-status "v-change-sys-ip-status")
- [v-change-sys-language](https://hestiacp.com/docs/reference/cli.html#v-change-sys-language "v-change-sys-language")
- [v-change-sys-php](https://hestiacp.com/docs/reference/cli.html#v-change-sys-php "v-change-sys-php")
- [v-change-sys-port](https://hestiacp.com/docs/reference/cli.html#v-change-sys-port "v-change-sys-port")
- [v-change-sys-release](https://hestiacp.com/docs/reference/cli.html#v-change-sys-release "v-change-sys-release")
- [v-change-sys-service-config](https://hestiacp.com/docs/reference/cli.html#v-change-sys-service-config "v-change-sys-service-config")
- [v-change-sys-timezone](https://hestiacp.com/docs/reference/cli.html#v-change-sys-timezone "v-change-sys-timezone")
- [v-change-sys-web-terminal-port](https://hestiacp.com/docs/reference/cli.html#v-change-sys-web-terminal-port "v-change-sys-web-terminal-port")
- [v-change-sys-webmail](https://hestiacp.com/docs/reference/cli.html#v-change-sys-webmail "v-change-sys-webmail")
- [v-change-user-config-value](https://hestiacp.com/docs/reference/cli.html#v-change-user-config-value "v-change-user-config-value")
- [v-change-user-contact](https://hestiacp.com/docs/reference/cli.html#v-change-user-contact "v-change-user-contact")
- [v-change-user-language](https://hestiacp.com/docs/reference/cli.html#v-change-user-language "v-change-user-language")
- [v-change-user-name](https://hestiacp.com/docs/reference/cli.html#v-change-user-name "v-change-user-name")
- [v-change-user-ns](https://hestiacp.com/docs/reference/cli.html#v-change-user-ns "v-change-user-ns")
- [v-change-user-package](https://hestiacp.com/docs/reference/cli.html#v-change-user-package "v-change-user-package")
- [v-change-user-password](https://hestiacp.com/docs/reference/cli.html#v-change-user-password "v-change-user-password")
- [v-change-user-php-cli](https://hestiacp.com/docs/reference/cli.html#v-change-user-php-cli "v-change-user-php-cli")
- [v-change-user-rkey](https://hestiacp.com/docs/reference/cli.html#v-change-user-rkey "v-change-user-rkey")
- [v-change-user-role](https://hestiacp.com/docs/reference/cli.html#v-change-user-role "v-change-user-role")
- [v-change-user-shell](https://hestiacp.com/docs/reference/cli.html#v-change-user-shell "v-change-user-shell")
- [v-change-user-sort-order](https://hestiacp.com/docs/reference/cli.html#v-change-user-sort-order "v-change-user-sort-order")
- [v-change-user-template](https://hestiacp.com/docs/reference/cli.html#v-change-user-template "v-change-user-template")
- [v-change-user-theme](https://hestiacp.com/docs/reference/cli.html#v-change-user-theme "v-change-user-theme")
- [v-change-web-domain-backend-tpl](https://hestiacp.com/docs/reference/cli.html#v-change-web-domain-backend-tpl "v-change-web-domain-backend-tpl")
- [v-change-web-domain-dirlist](https://hestiacp.com/docs/reference/cli.html#v-change-web-domain-dirlist "v-change-web-domain-dirlist")
- [v-change-web-domain-docroot](https://hestiacp.com/docs/reference/cli.html#v-change-web-domain-docroot "v-change-web-domain-docroot")
- [v-change-web-domain-ftp-password](https://hestiacp.com/docs/reference/cli.html#v-change-web-domain-ftp-password "v-change-web-domain-ftp-password")
- [v-change-web-domain-ftp-path](https://hestiacp.com/docs/reference/cli.html#v-change-web-domain-ftp-path "v-change-web-domain-ftp-path")
- [v-change-web-domain-httpauth](https://hestiacp.com/docs/reference/cli.html#v-change-web-domain-httpauth "v-change-web-domain-httpauth")
- [v-change-web-domain-ip](https://hestiacp.com/docs/reference/cli.html#v-change-web-domain-ip "v-change-web-domain-ip")
- [v-change-web-domain-name](https://hestiacp.com/docs/reference/cli.html#v-change-web-domain-name "v-change-web-domain-name")
- [v-change-web-domain-proxy-tpl](https://hestiacp.com/docs/reference/cli.html#v-change-web-domain-proxy-tpl "v-change-web-domain-proxy-tpl")
- [v-change-web-domain-sslcert](https://hestiacp.com/docs/reference/cli.html#v-change-web-domain-sslcert "v-change-web-domain-sslcert")
- [v-change-web-domain-sslhome](https://hestiacp.com/docs/reference/cli.html#v-change-web-domain-sslhome "v-change-web-domain-sslhome")
- [v-change-web-domain-stats](https://hestiacp.com/docs/reference/cli.html#v-change-web-domain-stats "v-change-web-domain-stats")
- [v-change-web-domain-tpl](https://hestiacp.com/docs/reference/cli.html#v-change-web-domain-tpl "v-change-web-domain-tpl")
- [v-check-access-key](https://hestiacp.com/docs/reference/cli.html#v-check-access-key "v-check-access-key")
- [v-check-api-key](https://hestiacp.com/docs/reference/cli.html#v-check-api-key "v-check-api-key")
- [v-check-fs-permission](https://hestiacp.com/docs/reference/cli.html#v-check-fs-permission "v-check-fs-permission")
- [v-check-mail-account-hash](https://hestiacp.com/docs/reference/cli.html#v-check-mail-account-hash "v-check-mail-account-hash")
- [v-check-user-2fa](https://hestiacp.com/docs/reference/cli.html#v-check-user-2fa "v-check-user-2fa")
- [v-check-user-hash](https://hestiacp.com/docs/reference/cli.html#v-check-user-hash "v-check-user-hash")
- [v-check-user-password](https://hestiacp.com/docs/reference/cli.html#v-check-user-password "v-check-user-password")
- [v-copy-fs-directory](https://hestiacp.com/docs/reference/cli.html#v-copy-fs-directory "v-copy-fs-directory")
- [v-copy-fs-file](https://hestiacp.com/docs/reference/cli.html#v-copy-fs-file "v-copy-fs-file")
- [v-copy-user-package](https://hestiacp.com/docs/reference/cli.html#v-copy-user-package "v-copy-user-package")
- [v-delete-access-key](https://hestiacp.com/docs/reference/cli.html#v-delete-access-key "v-delete-access-key")
- [v-delete-backup-host](https://hestiacp.com/docs/reference/cli.html#v-delete-backup-host "v-delete-backup-host")
- [v-delete-cron-hestia-autoupdate](https://hestiacp.com/docs/reference/cli.html#v-delete-cron-hestia-autoupdate "v-delete-cron-hestia-autoupdate")
- [v-delete-cron-job](https://hestiacp.com/docs/reference/cli.html#v-delete-cron-job "v-delete-cron-job")
- [v-delete-cron-reports](https://hestiacp.com/docs/reference/cli.html#v-delete-cron-reports "v-delete-cron-reports")
- [v-delete-cron-restart-job](https://hestiacp.com/docs/reference/cli.html#v-delete-cron-restart-job "v-delete-cron-restart-job")
- [v-delete-database](https://hestiacp.com/docs/reference/cli.html#v-delete-database "v-delete-database")
- [v-delete-database-host](https://hestiacp.com/docs/reference/cli.html#v-delete-database-host "v-delete-database-host")
- [v-delete-database-temp-user](https://hestiacp.com/docs/reference/cli.html#v-delete-database-temp-user "v-delete-database-temp-user")
- [v-delete-databases](https://hestiacp.com/docs/reference/cli.html#v-delete-databases "v-delete-databases")
- [v-delete-dns-domain](https://hestiacp.com/docs/reference/cli.html#v-delete-dns-domain "v-delete-dns-domain")
- [v-delete-dns-domains](https://hestiacp.com/docs/reference/cli.html#v-delete-dns-domains "v-delete-dns-domains")
- [v-delete-dns-domains-src](https://hestiacp.com/docs/reference/cli.html#v-delete-dns-domains-src "v-delete-dns-domains-src")
- [v-delete-dns-on-web-alias](https://hestiacp.com/docs/reference/cli.html#v-delete-dns-on-web-alias "v-delete-dns-on-web-alias")
- [v-delete-dns-record](https://hestiacp.com/docs/reference/cli.html#v-delete-dns-record "v-delete-dns-record")
- [v-delete-domain](https://hestiacp.com/docs/reference/cli.html#v-delete-domain "v-delete-domain")
- [v-delete-fastcgi-cache](https://hestiacp.com/docs/reference/cli.html#v-delete-fastcgi-cache "v-delete-fastcgi-cache")
- [v-delete-firewall-ban](https://hestiacp.com/docs/reference/cli.html#v-delete-firewall-ban "v-delete-firewall-ban")
- [v-delete-firewall-chain](https://hestiacp.com/docs/reference/cli.html#v-delete-firewall-chain "v-delete-firewall-chain")
- [v-delete-firewall-ipset](https://hestiacp.com/docs/reference/cli.html#v-delete-firewall-ipset "v-delete-firewall-ipset")
- [v-delete-firewall-rule](https://hestiacp.com/docs/reference/cli.html#v-delete-firewall-rule "v-delete-firewall-rule")
- [v-delete-fs-directory](https://hestiacp.com/docs/reference/cli.html#v-delete-fs-directory "v-delete-fs-directory")
- [v-delete-fs-file](https://hestiacp.com/docs/reference/cli.html#v-delete-fs-file "v-delete-fs-file")
- [v-delete-letsencrypt-domain](https://hestiacp.com/docs/reference/cli.html#v-delete-letsencrypt-domain "v-delete-letsencrypt-domain")
- [v-delete-mail-account](https://hestiacp.com/docs/reference/cli.html#v-delete-mail-account "v-delete-mail-account")
- [v-delete-mail-account-alias](https://hestiacp.com/docs/reference/cli.html#v-delete-mail-account-alias "v-delete-mail-account-alias")
- [v-delete-mail-account-autoreply](https://hestiacp.com/docs/reference/cli.html#v-delete-mail-account-autoreply "v-delete-mail-account-autoreply")
- [v-delete-mail-account-forward](https://hestiacp.com/docs/reference/cli.html#v-delete-mail-account-forward "v-delete-mail-account-forward")
- [v-delete-mail-account-fwd-only](https://hestiacp.com/docs/reference/cli.html#v-delete-mail-account-fwd-only "v-delete-mail-account-fwd-only")
- [v-delete-mail-domain](https://hestiacp.com/docs/reference/cli.html#v-delete-mail-domain "v-delete-mail-domain")
- [v-delete-mail-domain-antispam](https://hestiacp.com/docs/reference/cli.html#v-delete-mail-domain-antispam "v-delete-mail-domain-antispam")
- [v-delete-mail-domain-antivirus](https://hestiacp.com/docs/reference/cli.html#v-delete-mail-domain-antivirus "v-delete-mail-domain-antivirus")
- [v-delete-mail-domain-catchall](https://hestiacp.com/docs/reference/cli.html#v-delete-mail-domain-catchall "v-delete-mail-domain-catchall")
- [v-delete-mail-domain-dkim](https://hestiacp.com/docs/reference/cli.html#v-delete-mail-domain-dkim "v-delete-mail-domain-dkim")
- [v-delete-mail-domain-reject](https://hestiacp.com/docs/reference/cli.html#v-delete-mail-domain-reject "v-delete-mail-domain-reject")
- [v-delete-mail-domain-smtp-relay](https://hestiacp.com/docs/reference/cli.html#v-delete-mail-domain-smtp-relay "v-delete-mail-domain-smtp-relay")
- [v-delete-mail-domain-ssl](https://hestiacp.com/docs/reference/cli.html#v-delete-mail-domain-ssl "v-delete-mail-domain-ssl")
- [v-delete-mail-domain-webmail](https://hestiacp.com/docs/reference/cli.html#v-delete-mail-domain-webmail "v-delete-mail-domain-webmail")
- [v-delete-mail-domains](https://hestiacp.com/docs/reference/cli.html#v-delete-mail-domains "v-delete-mail-domains")
- [v-delete-remote-dns-domain](https://hestiacp.com/docs/reference/cli.html#v-delete-remote-dns-domain "v-delete-remote-dns-domain")
- [v-delete-remote-dns-domains](https://hestiacp.com/docs/reference/cli.html#v-delete-remote-dns-domains "v-delete-remote-dns-domains")
- [v-delete-remote-dns-host](https://hestiacp.com/docs/reference/cli.html#v-delete-remote-dns-host "v-delete-remote-dns-host")
- [v-delete-remote-dns-record](https://hestiacp.com/docs/reference/cli.html#v-delete-remote-dns-record "v-delete-remote-dns-record")
- [v-delete-sys-api-ip](https://hestiacp.com/docs/reference/cli.html#v-delete-sys-api-ip "v-delete-sys-api-ip")
- [v-delete-sys-filemanager](https://hestiacp.com/docs/reference/cli.html#v-delete-sys-filemanager "v-delete-sys-filemanager")
- [v-delete-sys-firewall](https://hestiacp.com/docs/reference/cli.html#v-delete-sys-firewall "v-delete-sys-firewall")
- [v-delete-sys-ip](https://hestiacp.com/docs/reference/cli.html#v-delete-sys-ip "v-delete-sys-ip")
- [v-delete-sys-mail-queue](https://hestiacp.com/docs/reference/cli.html#v-delete-sys-mail-queue "v-delete-sys-mail-queue")
- [v-delete-sys-pma-sso](https://hestiacp.com/docs/reference/cli.html#v-delete-sys-pma-sso "v-delete-sys-pma-sso")
- [v-delete-sys-quota](https://hestiacp.com/docs/reference/cli.html#v-delete-sys-quota "v-delete-sys-quota")
- [v-delete-sys-sftp-jail](https://hestiacp.com/docs/reference/cli.html#v-delete-sys-sftp-jail "v-delete-sys-sftp-jail")
- [v-delete-sys-smtp](https://hestiacp.com/docs/reference/cli.html#v-delete-sys-smtp "v-delete-sys-smtp")
- [v-delete-sys-smtp-relay](https://hestiacp.com/docs/reference/cli.html#v-delete-sys-smtp-relay "v-delete-sys-smtp-relay")
- [v-delete-sys-web-terminal](https://hestiacp.com/docs/reference/cli.html#v-delete-sys-web-terminal "v-delete-sys-web-terminal")
- [v-delete-user](https://hestiacp.com/docs/reference/cli.html#v-delete-user "v-delete-user")
- [v-delete-user-2fa](https://hestiacp.com/docs/reference/cli.html#v-delete-user-2fa "v-delete-user-2fa")
- [v-delete-user-auth-log](https://hestiacp.com/docs/reference/cli.html#v-delete-user-auth-log "v-delete-user-auth-log")
- [v-delete-user-backup](https://hestiacp.com/docs/reference/cli.html#v-delete-user-backup "v-delete-user-backup")
- [v-delete-user-backup-exclusions](https://hestiacp.com/docs/reference/cli.html#v-delete-user-backup-exclusions "v-delete-user-backup-exclusions")
- [v-delete-user-ips](https://hestiacp.com/docs/reference/cli.html#v-delete-user-ips "v-delete-user-ips")
- [v-delete-user-log](https://hestiacp.com/docs/reference/cli.html#v-delete-user-log "v-delete-user-log")
- [v-delete-user-notification](https://hestiacp.com/docs/reference/cli.html#v-delete-user-notification "v-delete-user-notification")
- [v-delete-user-package](https://hestiacp.com/docs/reference/cli.html#v-delete-user-package "v-delete-user-package")
- [v-delete-user-sftp-jail](https://hestiacp.com/docs/reference/cli.html#v-delete-user-sftp-jail "v-delete-user-sftp-jail")
- [v-delete-user-ssh-key](https://hestiacp.com/docs/reference/cli.html#v-delete-user-ssh-key "v-delete-user-ssh-key")
- [v-delete-user-stats](https://hestiacp.com/docs/reference/cli.html#v-delete-user-stats "v-delete-user-stats")
- [v-delete-web-domain](https://hestiacp.com/docs/reference/cli.html#v-delete-web-domain "v-delete-web-domain")
- [v-delete-web-domain-alias](https://hestiacp.com/docs/reference/cli.html#v-delete-web-domain-alias "v-delete-web-domain-alias")
- [v-delete-web-domain-allow-users](https://hestiacp.com/docs/reference/cli.html#v-delete-web-domain-allow-users "v-delete-web-domain-allow-users")
- [v-delete-web-domain-backend](https://hestiacp.com/docs/reference/cli.html#v-delete-web-domain-backend "v-delete-web-domain-backend")
- [v-delete-web-domain-ftp](https://hestiacp.com/docs/reference/cli.html#v-delete-web-domain-ftp "v-delete-web-domain-ftp")
- [v-delete-web-domain-httpauth](https://hestiacp.com/docs/reference/cli.html#v-delete-web-domain-httpauth "v-delete-web-domain-httpauth")
- [v-delete-web-domain-proxy](https://hestiacp.com/docs/reference/cli.html#v-delete-web-domain-proxy "v-delete-web-domain-proxy")
- [v-delete-web-domain-redirect](https://hestiacp.com/docs/reference/cli.html#v-delete-web-domain-redirect "v-delete-web-domain-redirect")
- [v-delete-web-domain-ssl](https://hestiacp.com/docs/reference/cli.html#v-delete-web-domain-ssl "v-delete-web-domain-ssl")
- [v-delete-web-domain-ssl-force](https://hestiacp.com/docs/reference/cli.html#v-delete-web-domain-ssl-force "v-delete-web-domain-ssl-force")
- [v-delete-web-domain-ssl-hsts](https://hestiacp.com/docs/reference/cli.html#v-delete-web-domain-ssl-hsts "v-delete-web-domain-ssl-hsts")
- [v-delete-web-domain-stats](https://hestiacp.com/docs/reference/cli.html#v-delete-web-domain-stats "v-delete-web-domain-stats")
- [v-delete-web-domain-stats-user](https://hestiacp.com/docs/reference/cli.html#v-delete-web-domain-stats-user "v-delete-web-domain-stats-user")
- [v-delete-web-domains](https://hestiacp.com/docs/reference/cli.html#v-delete-web-domains "v-delete-web-domains")
- [v-delete-web-php](https://hestiacp.com/docs/reference/cli.html#v-delete-web-php "v-delete-web-php")
- [v-download-backup](https://hestiacp.com/docs/reference/cli.html#v-download-backup "v-download-backup")
- [v-dump-database](https://hestiacp.com/docs/reference/cli.html#v-dump-database "v-dump-database")
- [v-dump-site](https://hestiacp.com/docs/reference/cli.html#v-dump-site "v-dump-site")
- [v-export-rrd](https://hestiacp.com/docs/reference/cli.html#v-export-rrd "v-export-rrd")
- [v-extract-fs-archive](https://hestiacp.com/docs/reference/cli.html#v-extract-fs-archive "v-extract-fs-archive")
- [v-generate-api-key](https://hestiacp.com/docs/reference/cli.html#v-generate-api-key "v-generate-api-key")
- [v-generate-debug-report](https://hestiacp.com/docs/reference/cli.html#v-generate-debug-report "v-generate-debug-report")
- [v-generate-password-hash](https://hestiacp.com/docs/reference/cli.html#v-generate-password-hash "v-generate-password-hash")
- [v-generate-ssl-cert](https://hestiacp.com/docs/reference/cli.html#v-generate-ssl-cert "v-generate-ssl-cert")
- [v-get-dns-domain-value](https://hestiacp.com/docs/reference/cli.html#v-get-dns-domain-value "v-get-dns-domain-value")
- [v-get-fs-file-type](https://hestiacp.com/docs/reference/cli.html#v-get-fs-file-type "v-get-fs-file-type")
- [v-get-mail-account-value](https://hestiacp.com/docs/reference/cli.html#v-get-mail-account-value "v-get-mail-account-value")
- [v-get-mail-domain-value](https://hestiacp.com/docs/reference/cli.html#v-get-mail-domain-value "v-get-mail-domain-value")
- [v-get-sys-timezone](https://hestiacp.com/docs/reference/cli.html#v-get-sys-timezone "v-get-sys-timezone")
- [v-get-sys-timezones](https://hestiacp.com/docs/reference/cli.html#v-get-sys-timezones "v-get-sys-timezones")
- [v-get-user-salt](https://hestiacp.com/docs/reference/cli.html#v-get-user-salt "v-get-user-salt")
- [v-get-user-value](https://hestiacp.com/docs/reference/cli.html#v-get-user-value "v-get-user-value")
- [v-import-cpanel](https://hestiacp.com/docs/reference/cli.html#v-import-cpanel "v-import-cpanel")
- [v-insert-dns-domain](https://hestiacp.com/docs/reference/cli.html#v-insert-dns-domain "v-insert-dns-domain")
- [v-insert-dns-record](https://hestiacp.com/docs/reference/cli.html#v-insert-dns-record "v-insert-dns-record")
- [v-insert-dns-records](https://hestiacp.com/docs/reference/cli.html#v-insert-dns-records "v-insert-dns-records")
- [v-list-access-key](https://hestiacp.com/docs/reference/cli.html#v-list-access-key "v-list-access-key")
- [v-list-access-keys](https://hestiacp.com/docs/reference/cli.html#v-list-access-keys "v-list-access-keys")
- [v-list-api](https://hestiacp.com/docs/reference/cli.html#v-list-api "v-list-api")
- [v-list-apis](https://hestiacp.com/docs/reference/cli.html#v-list-apis "v-list-apis")
- [v-list-backup-host](https://hestiacp.com/docs/reference/cli.html#v-list-backup-host "v-list-backup-host")
- [v-list-cron-job](https://hestiacp.com/docs/reference/cli.html#v-list-cron-job "v-list-cron-job")
- [v-list-cron-jobs](https://hestiacp.com/docs/reference/cli.html#v-list-cron-jobs "v-list-cron-jobs")
- [v-list-database](https://hestiacp.com/docs/reference/cli.html#v-list-database "v-list-database")
- [v-list-database-host](https://hestiacp.com/docs/reference/cli.html#v-list-database-host "v-list-database-host")
- [v-list-database-hosts](https://hestiacp.com/docs/reference/cli.html#v-list-database-hosts "v-list-database-hosts")
- [v-list-database-types](https://hestiacp.com/docs/reference/cli.html#v-list-database-types "v-list-database-types")
- [v-list-databases](https://hestiacp.com/docs/reference/cli.html#v-list-databases "v-list-databases")
- [v-list-default-php](https://hestiacp.com/docs/reference/cli.html#v-list-default-php "v-list-default-php")
- [v-list-dns-domain](https://hestiacp.com/docs/reference/cli.html#v-list-dns-domain "v-list-dns-domain")
- [v-list-dns-domains](https://hestiacp.com/docs/reference/cli.html#v-list-dns-domains "v-list-dns-domains")
- [v-list-dns-records](https://hestiacp.com/docs/reference/cli.html#v-list-dns-records "v-list-dns-records")
- [v-list-dns-template](https://hestiacp.com/docs/reference/cli.html#v-list-dns-template "v-list-dns-template")
- [v-list-dns-templates](https://hestiacp.com/docs/reference/cli.html#v-list-dns-templates "v-list-dns-templates")
- [v-list-dnssec-public-key](https://hestiacp.com/docs/reference/cli.html#v-list-dnssec-public-key "v-list-dnssec-public-key")
- [v-list-firewall](https://hestiacp.com/docs/reference/cli.html#v-list-firewall "v-list-firewall")
- [v-list-firewall-ban](https://hestiacp.com/docs/reference/cli.html#v-list-firewall-ban "v-list-firewall-ban")
- [v-list-firewall-ipset](https://hestiacp.com/docs/reference/cli.html#v-list-firewall-ipset "v-list-firewall-ipset")
- [v-list-firewall-rule](https://hestiacp.com/docs/reference/cli.html#v-list-firewall-rule "v-list-firewall-rule")
- [v-list-fs-directory](https://hestiacp.com/docs/reference/cli.html#v-list-fs-directory "v-list-fs-directory")
- [v-list-letsencrypt-user](https://hestiacp.com/docs/reference/cli.html#v-list-letsencrypt-user "v-list-letsencrypt-user")
- [v-list-mail-account](https://hestiacp.com/docs/reference/cli.html#v-list-mail-account "v-list-mail-account")
- [v-list-mail-account-autoreply](https://hestiacp.com/docs/reference/cli.html#v-list-mail-account-autoreply "v-list-mail-account-autoreply")
- [v-list-mail-accounts](https://hestiacp.com/docs/reference/cli.html#v-list-mail-accounts "v-list-mail-accounts")
- [v-list-mail-domain](https://hestiacp.com/docs/reference/cli.html#v-list-mail-domain "v-list-mail-domain")
- [v-list-mail-domain-dkim](https://hestiacp.com/docs/reference/cli.html#v-list-mail-domain-dkim "v-list-mail-domain-dkim")
- [v-list-mail-domain-dkim-dns](https://hestiacp.com/docs/reference/cli.html#v-list-mail-domain-dkim-dns "v-list-mail-domain-dkim-dns")
- [v-list-mail-domain-ssl](https://hestiacp.com/docs/reference/cli.html#v-list-mail-domain-ssl "v-list-mail-domain-ssl")
- [v-list-mail-domains](https://hestiacp.com/docs/reference/cli.html#v-list-mail-domains "v-list-mail-domains")
- [v-list-remote-dns-hosts](https://hestiacp.com/docs/reference/cli.html#v-list-remote-dns-hosts "v-list-remote-dns-hosts")
- [v-list-sys-clamd-config](https://hestiacp.com/docs/reference/cli.html#v-list-sys-clamd-config "v-list-sys-clamd-config")
- [v-list-sys-config](https://hestiacp.com/docs/reference/cli.html#v-list-sys-config "v-list-sys-config")
- [v-list-sys-cpu-status](https://hestiacp.com/docs/reference/cli.html#v-list-sys-cpu-status "v-list-sys-cpu-status")
- [v-list-sys-db-status](https://hestiacp.com/docs/reference/cli.html#v-list-sys-db-status "v-list-sys-db-status")
- [v-list-sys-disk-status](https://hestiacp.com/docs/reference/cli.html#v-list-sys-disk-status "v-list-sys-disk-status")
- [v-list-sys-dns-status](https://hestiacp.com/docs/reference/cli.html#v-list-sys-dns-status "v-list-sys-dns-status")
- [v-list-sys-dovecot-config](https://hestiacp.com/docs/reference/cli.html#v-list-sys-dovecot-config "v-list-sys-dovecot-config")
- [v-list-sys-hestia-autoupdate](https://hestiacp.com/docs/reference/cli.html#v-list-sys-hestia-autoupdate "v-list-sys-hestia-autoupdate")
- [v-list-sys-hestia-ssl](https://hestiacp.com/docs/reference/cli.html#v-list-sys-hestia-ssl "v-list-sys-hestia-ssl")
- [v-list-sys-hestia-updates](https://hestiacp.com/docs/reference/cli.html#v-list-sys-hestia-updates "v-list-sys-hestia-updates")
- [v-list-sys-info](https://hestiacp.com/docs/reference/cli.html#v-list-sys-info "v-list-sys-info")
- [v-list-sys-interfaces](https://hestiacp.com/docs/reference/cli.html#v-list-sys-interfaces "v-list-sys-interfaces")
- [v-list-sys-ip](https://hestiacp.com/docs/reference/cli.html#v-list-sys-ip "v-list-sys-ip")
- [v-list-sys-ips](https://hestiacp.com/docs/reference/cli.html#v-list-sys-ips "v-list-sys-ips")
- [v-list-sys-languages](https://hestiacp.com/docs/reference/cli.html#v-list-sys-languages "v-list-sys-languages")
- [v-list-sys-mail-status](https://hestiacp.com/docs/reference/cli.html#v-list-sys-mail-status "v-list-sys-mail-status")
- [v-list-sys-memory-status](https://hestiacp.com/docs/reference/cli.html#v-list-sys-memory-status "v-list-sys-memory-status")
- [v-list-sys-mysql-config](https://hestiacp.com/docs/reference/cli.html#v-list-sys-mysql-config "v-list-sys-mysql-config")
- [v-list-sys-network-status](https://hestiacp.com/docs/reference/cli.html#v-list-sys-network-status "v-list-sys-network-status")
- [v-list-sys-nginx-config](https://hestiacp.com/docs/reference/cli.html#v-list-sys-nginx-config "v-list-sys-nginx-config")
- [v-list-sys-pgsql-config](https://hestiacp.com/docs/reference/cli.html#v-list-sys-pgsql-config "v-list-sys-pgsql-config")
- [v-list-sys-php](https://hestiacp.com/docs/reference/cli.html#v-list-sys-php "v-list-sys-php")
- [v-list-sys-php-config](https://hestiacp.com/docs/reference/cli.html#v-list-sys-php-config "v-list-sys-php-config")
- [v-list-sys-proftpd-config](https://hestiacp.com/docs/reference/cli.html#v-list-sys-proftpd-config "v-list-sys-proftpd-config")
- [v-list-sys-rrd](https://hestiacp.com/docs/reference/cli.html#v-list-sys-rrd "v-list-sys-rrd")
- [v-list-sys-services](https://hestiacp.com/docs/reference/cli.html#v-list-sys-services "v-list-sys-services")
- [v-list-sys-shells](https://hestiacp.com/docs/reference/cli.html#v-list-sys-shells "v-list-sys-shells")
- [v-list-sys-spamd-config](https://hestiacp.com/docs/reference/cli.html#v-list-sys-spamd-config "v-list-sys-spamd-config")
- [v-list-sys-sshd-port](https://hestiacp.com/docs/reference/cli.html#v-list-sys-sshd-port "v-list-sys-sshd-port")
- [v-list-sys-themes](https://hestiacp.com/docs/reference/cli.html#v-list-sys-themes "v-list-sys-themes")
- [v-list-sys-users](https://hestiacp.com/docs/reference/cli.html#v-list-sys-users "v-list-sys-users")
- [v-list-sys-vsftpd-config](https://hestiacp.com/docs/reference/cli.html#v-list-sys-vsftpd-config "v-list-sys-vsftpd-config")
- [v-list-sys-web-status](https://hestiacp.com/docs/reference/cli.html#v-list-sys-web-status "v-list-sys-web-status")
- [v-list-sys-webmail](https://hestiacp.com/docs/reference/cli.html#v-list-sys-webmail "v-list-sys-webmail")
- [v-list-user](https://hestiacp.com/docs/reference/cli.html#v-list-user "v-list-user")
- [v-list-user-auth-log](https://hestiacp.com/docs/reference/cli.html#v-list-user-auth-log "v-list-user-auth-log")
- [v-list-user-backup](https://hestiacp.com/docs/reference/cli.html#v-list-user-backup "v-list-user-backup")
- [v-list-user-backup-exclusions](https://hestiacp.com/docs/reference/cli.html#v-list-user-backup-exclusions "v-list-user-backup-exclusions")
- [v-list-user-backups](https://hestiacp.com/docs/reference/cli.html#v-list-user-backups "v-list-user-backups")
- [v-list-user-ips](https://hestiacp.com/docs/reference/cli.html#v-list-user-ips "v-list-user-ips")
- [v-list-user-log](https://hestiacp.com/docs/reference/cli.html#v-list-user-log "v-list-user-log")
- [v-list-user-notifications](https://hestiacp.com/docs/reference/cli.html#v-list-user-notifications "v-list-user-notifications")
- [v-list-user-ns](https://hestiacp.com/docs/reference/cli.html#v-list-user-ns "v-list-user-ns")
- [v-list-user-package](https://hestiacp.com/docs/reference/cli.html#v-list-user-package "v-list-user-package")
- [v-list-user-packages](https://hestiacp.com/docs/reference/cli.html#v-list-user-packages "v-list-user-packages")
- [v-list-user-ssh-key](https://hestiacp.com/docs/reference/cli.html#v-list-user-ssh-key "v-list-user-ssh-key")
- [v-list-user-stats](https://hestiacp.com/docs/reference/cli.html#v-list-user-stats "v-list-user-stats")
- [v-list-users](https://hestiacp.com/docs/reference/cli.html#v-list-users "v-list-users")
- [v-list-users-stats](https://hestiacp.com/docs/reference/cli.html#v-list-users-stats "v-list-users-stats")
- [v-list-web-domain](https://hestiacp.com/docs/reference/cli.html#v-list-web-domain "v-list-web-domain")
- [v-list-web-domain-accesslog](https://hestiacp.com/docs/reference/cli.html#v-list-web-domain-accesslog "v-list-web-domain-accesslog")
- [v-list-web-domain-errorlog](https://hestiacp.com/docs/reference/cli.html#v-list-web-domain-errorlog "v-list-web-domain-errorlog")
- [v-list-web-domain-ssl](https://hestiacp.com/docs/reference/cli.html#v-list-web-domain-ssl "v-list-web-domain-ssl")
- [v-list-web-domains](https://hestiacp.com/docs/reference/cli.html#v-list-web-domains "v-list-web-domains")
- [v-list-web-stats](https://hestiacp.com/docs/reference/cli.html#v-list-web-stats "v-list-web-stats")
- [v-list-web-templates](https://hestiacp.com/docs/reference/cli.html#v-list-web-templates "v-list-web-templates")
- [v-list-web-templates-backend](https://hestiacp.com/docs/reference/cli.html#v-list-web-templates-backend "v-list-web-templates-backend")
- [v-list-web-templates-proxy](https://hestiacp.com/docs/reference/cli.html#v-list-web-templates-proxy "v-list-web-templates-proxy")
- [v-log-action](https://hestiacp.com/docs/reference/cli.html#v-log-action "v-log-action")
- [v-log-user-login](https://hestiacp.com/docs/reference/cli.html#v-log-user-login "v-log-user-login")
- [v-log-user-logout](https://hestiacp.com/docs/reference/cli.html#v-log-user-logout "v-log-user-logout")
- [v-move-fs-directory](https://hestiacp.com/docs/reference/cli.html#v-move-fs-directory "v-move-fs-directory")
- [v-move-fs-file](https://hestiacp.com/docs/reference/cli.html#v-move-fs-file "v-move-fs-file")
- [v-open-fs-config](https://hestiacp.com/docs/reference/cli.html#v-open-fs-config "v-open-fs-config")
- [v-open-fs-file](https://hestiacp.com/docs/reference/cli.html#v-open-fs-file "v-open-fs-file")
- [v-purge-nginx-cache](https://hestiacp.com/docs/reference/cli.html#v-purge-nginx-cache "v-purge-nginx-cache")
- [v-rebuild-all](https://hestiacp.com/docs/reference/cli.html#v-rebuild-all "v-rebuild-all")
- [v-rebuild-cron-jobs](https://hestiacp.com/docs/reference/cli.html#v-rebuild-cron-jobs "v-rebuild-cron-jobs")
- [v-rebuild-database](https://hestiacp.com/docs/reference/cli.html#v-rebuild-database "v-rebuild-database")
- [v-rebuild-databases](https://hestiacp.com/docs/reference/cli.html#v-rebuild-databases "v-rebuild-databases")
- [v-rebuild-dns-domain](https://hestiacp.com/docs/reference/cli.html#v-rebuild-dns-domain "v-rebuild-dns-domain")
- [v-rebuild-dns-domains](https://hestiacp.com/docs/reference/cli.html#v-rebuild-dns-domains "v-rebuild-dns-domains")
- [v-rebuild-mail-domain](https://hestiacp.com/docs/reference/cli.html#v-rebuild-mail-domain "v-rebuild-mail-domain")
- [v-rebuild-mail-domains](https://hestiacp.com/docs/reference/cli.html#v-rebuild-mail-domains "v-rebuild-mail-domains")
- [v-rebuild-user](https://hestiacp.com/docs/reference/cli.html#v-rebuild-user "v-rebuild-user")
- [v-rebuild-users](https://hestiacp.com/docs/reference/cli.html#v-rebuild-users "v-rebuild-users")
- [v-rebuild-web-domain](https://hestiacp.com/docs/reference/cli.html#v-rebuild-web-domain "v-rebuild-web-domain")
- [v-rebuild-web-domains](https://hestiacp.com/docs/reference/cli.html#v-rebuild-web-domains "v-rebuild-web-domains")
- [v-refresh-sys-theme](https://hestiacp.com/docs/reference/cli.html#v-refresh-sys-theme "v-refresh-sys-theme")
- [v-rename-user-package](https://hestiacp.com/docs/reference/cli.html#v-rename-user-package "v-rename-user-package")
- [v-repair-sys-config](https://hestiacp.com/docs/reference/cli.html#v-repair-sys-config "v-repair-sys-config")
- [v-restart-cron](https://hestiacp.com/docs/reference/cli.html#v-restart-cron "v-restart-cron")
- [v-restart-dns](https://hestiacp.com/docs/reference/cli.html#v-restart-dns "v-restart-dns")
- [v-restart-ftp](https://hestiacp.com/docs/reference/cli.html#v-restart-ftp "v-restart-ftp")
- [v-restart-mail](https://hestiacp.com/docs/reference/cli.html#v-restart-mail "v-restart-mail")
- [v-restart-proxy](https://hestiacp.com/docs/reference/cli.html#v-restart-proxy "v-restart-proxy")
- [v-restart-service](https://hestiacp.com/docs/reference/cli.html#v-restart-service "v-restart-service")
- [v-restart-system](https://hestiacp.com/docs/reference/cli.html#v-restart-system "v-restart-system")
- [v-restart-web](https://hestiacp.com/docs/reference/cli.html#v-restart-web "v-restart-web")
- [v-restart-web-backend](https://hestiacp.com/docs/reference/cli.html#v-restart-web-backend "v-restart-web-backend")
- [v-restore-cron-job](https://hestiacp.com/docs/reference/cli.html#v-restore-cron-job "v-restore-cron-job")
- [v-restore-database](https://hestiacp.com/docs/reference/cli.html#v-restore-database "v-restore-database")
- [v-restore-dns-domain](https://hestiacp.com/docs/reference/cli.html#v-restore-dns-domain "v-restore-dns-domain")
- [v-restore-mail-domain](https://hestiacp.com/docs/reference/cli.html#v-restore-mail-domain "v-restore-mail-domain")
- [v-restore-user](https://hestiacp.com/docs/reference/cli.html#v-restore-user "v-restore-user")
- [v-restore-web-domain](https://hestiacp.com/docs/reference/cli.html#v-restore-web-domain "v-restore-web-domain")
- [v-revoke-api-key](https://hestiacp.com/docs/reference/cli.html#v-revoke-api-key "v-revoke-api-key")
- [v-run-cli-cmd](https://hestiacp.com/docs/reference/cli.html#v-run-cli-cmd "v-run-cli-cmd")
- [v-schedule-letsencrypt-domain](https://hestiacp.com/docs/reference/cli.html#v-schedule-letsencrypt-domain "v-schedule-letsencrypt-domain")
- [v-schedule-user-backup](https://hestiacp.com/docs/reference/cli.html#v-schedule-user-backup "v-schedule-user-backup")
- [v-schedule-user-backup-download](https://hestiacp.com/docs/reference/cli.html#v-schedule-user-backup-download "v-schedule-user-backup-download")
- [v-schedule-user-restore](https://hestiacp.com/docs/reference/cli.html#v-schedule-user-restore "v-schedule-user-restore")
- [v-search-command](https://hestiacp.com/docs/reference/cli.html#v-search-command "v-search-command")
- [v-search-domain-owner](https://hestiacp.com/docs/reference/cli.html#v-search-domain-owner "v-search-domain-owner")
- [v-search-fs-object](https://hestiacp.com/docs/reference/cli.html#v-search-fs-object "v-search-fs-object")
- [v-search-object](https://hestiacp.com/docs/reference/cli.html#v-search-object "v-search-object")
- [v-search-user-object](https://hestiacp.com/docs/reference/cli.html#v-search-user-object "v-search-user-object")
- [v-start-service](https://hestiacp.com/docs/reference/cli.html#v-start-service "v-start-service")
- [v-stop-firewall](https://hestiacp.com/docs/reference/cli.html#v-stop-firewall "v-stop-firewall")
- [v-stop-service](https://hestiacp.com/docs/reference/cli.html#v-stop-service "v-stop-service")
- [v-suspend-cron-job](https://hestiacp.com/docs/reference/cli.html#v-suspend-cron-job "v-suspend-cron-job")
- [v-suspend-cron-jobs](https://hestiacp.com/docs/reference/cli.html#v-suspend-cron-jobs "v-suspend-cron-jobs")
- [v-suspend-database](https://hestiacp.com/docs/reference/cli.html#v-suspend-database "v-suspend-database")
- [v-suspend-database-host](https://hestiacp.com/docs/reference/cli.html#v-suspend-database-host "v-suspend-database-host")
- [v-suspend-databases](https://hestiacp.com/docs/reference/cli.html#v-suspend-databases "v-suspend-databases")
- [v-suspend-dns-domain](https://hestiacp.com/docs/reference/cli.html#v-suspend-dns-domain "v-suspend-dns-domain")
- [v-suspend-dns-domains](https://hestiacp.com/docs/reference/cli.html#v-suspend-dns-domains "v-suspend-dns-domains")
- [v-suspend-dns-record](https://hestiacp.com/docs/reference/cli.html#v-suspend-dns-record "v-suspend-dns-record")
- [v-suspend-domain](https://hestiacp.com/docs/reference/cli.html#v-suspend-domain "v-suspend-domain")
- [v-suspend-firewall-rule](https://hestiacp.com/docs/reference/cli.html#v-suspend-firewall-rule "v-suspend-firewall-rule")
- [v-suspend-mail-account](https://hestiacp.com/docs/reference/cli.html#v-suspend-mail-account "v-suspend-mail-account")
- [v-suspend-mail-accounts](https://hestiacp.com/docs/reference/cli.html#v-suspend-mail-accounts "v-suspend-mail-accounts")
- [v-suspend-mail-domain](https://hestiacp.com/docs/reference/cli.html#v-suspend-mail-domain "v-suspend-mail-domain")
- [v-suspend-mail-domains](https://hestiacp.com/docs/reference/cli.html#v-suspend-mail-domains "v-suspend-mail-domains")
- [v-suspend-remote-dns-host](https://hestiacp.com/docs/reference/cli.html#v-suspend-remote-dns-host "v-suspend-remote-dns-host")
- [v-suspend-user](https://hestiacp.com/docs/reference/cli.html#v-suspend-user "v-suspend-user")
- [v-suspend-web-domain](https://hestiacp.com/docs/reference/cli.html#v-suspend-web-domain "v-suspend-web-domain")
- [v-suspend-web-domains](https://hestiacp.com/docs/reference/cli.html#v-suspend-web-domains "v-suspend-web-domains")
- [v-sync-dns-cluster](https://hestiacp.com/docs/reference/cli.html#v-sync-dns-cluster "v-sync-dns-cluster")
- [v-unsuspend-cron-job](https://hestiacp.com/docs/reference/cli.html#v-unsuspend-cron-job "v-unsuspend-cron-job")
- [v-unsuspend-cron-jobs](https://hestiacp.com/docs/reference/cli.html#v-unsuspend-cron-jobs "v-unsuspend-cron-jobs")
- [v-unsuspend-database](https://hestiacp.com/docs/reference/cli.html#v-unsuspend-database "v-unsuspend-database")
- [v-unsuspend-database-host](https://hestiacp.com/docs/reference/cli.html#v-unsuspend-database-host "v-unsuspend-database-host")
- [v-unsuspend-databases](https://hestiacp.com/docs/reference/cli.html#v-unsuspend-databases "v-unsuspend-databases")
- [v-unsuspend-dns-domain](https://hestiacp.com/docs/reference/cli.html#v-unsuspend-dns-domain "v-unsuspend-dns-domain")
- [v-unsuspend-dns-domains](https://hestiacp.com/docs/reference/cli.html#v-unsuspend-dns-domains "v-unsuspend-dns-domains")
- [v-unsuspend-dns-record](https://hestiacp.com/docs/reference/cli.html#v-unsuspend-dns-record "v-unsuspend-dns-record")
- [v-unsuspend-domain](https://hestiacp.com/docs/reference/cli.html#v-unsuspend-domain "v-unsuspend-domain")
- [v-unsuspend-firewall-rule](https://hestiacp.com/docs/reference/cli.html#v-unsuspend-firewall-rule "v-unsuspend-firewall-rule")
- [v-unsuspend-mail-account](https://hestiacp.com/docs/reference/cli.html#v-unsuspend-mail-account "v-unsuspend-mail-account")
- [v-unsuspend-mail-accounts](https://hestiacp.com/docs/reference/cli.html#v-unsuspend-mail-accounts "v-unsuspend-mail-accounts")
- [v-unsuspend-mail-domain](https://hestiacp.com/docs/reference/cli.html#v-unsuspend-mail-domain "v-unsuspend-mail-domain")
- [v-unsuspend-mail-domains](https://hestiacp.com/docs/reference/cli.html#v-unsuspend-mail-domains "v-unsuspend-mail-domains")
- [v-unsuspend-remote-dns-host](https://hestiacp.com/docs/reference/cli.html#v-unsuspend-remote-dns-host "v-unsuspend-remote-dns-host")
- [v-unsuspend-user](https://hestiacp.com/docs/reference/cli.html#v-unsuspend-user "v-unsuspend-user")
- [v-unsuspend-web-domain](https://hestiacp.com/docs/reference/cli.html#v-unsuspend-web-domain "v-unsuspend-web-domain")
- [v-unsuspend-web-domains](https://hestiacp.com/docs/reference/cli.html#v-unsuspend-web-domains "v-unsuspend-web-domains")
- [v-update-database-disk](https://hestiacp.com/docs/reference/cli.html#v-update-database-disk "v-update-database-disk")
- [v-update-databases-disk](https://hestiacp.com/docs/reference/cli.html#v-update-databases-disk "v-update-databases-disk")
- [v-update-dns-templates](https://hestiacp.com/docs/reference/cli.html#v-update-dns-templates "v-update-dns-templates")
- [v-update-firewall](https://hestiacp.com/docs/reference/cli.html#v-update-firewall "v-update-firewall")
- [v-update-firewall-ipset](https://hestiacp.com/docs/reference/cli.html#v-update-firewall-ipset "v-update-firewall-ipset")
- [v-update-host-certificate](https://hestiacp.com/docs/reference/cli.html#v-update-host-certificate "v-update-host-certificate")
- [v-update-letsencrypt-ssl](https://hestiacp.com/docs/reference/cli.html#v-update-letsencrypt-ssl "v-update-letsencrypt-ssl")
- [v-update-mail-domain-disk](https://hestiacp.com/docs/reference/cli.html#v-update-mail-domain-disk "v-update-mail-domain-disk")
- [v-update-mail-domain-ssl](https://hestiacp.com/docs/reference/cli.html#v-update-mail-domain-ssl "v-update-mail-domain-ssl")
- [v-update-mail-domains-disk](https://hestiacp.com/docs/reference/cli.html#v-update-mail-domains-disk "v-update-mail-domains-disk")
- [v-update-mail-templates](https://hestiacp.com/docs/reference/cli.html#v-update-mail-templates "v-update-mail-templates")
- [v-update-sys-defaults](https://hestiacp.com/docs/reference/cli.html#v-update-sys-defaults "v-update-sys-defaults")
- [v-update-sys-hestia](https://hestiacp.com/docs/reference/cli.html#v-update-sys-hestia "v-update-sys-hestia")
- [v-update-sys-hestia-all](https://hestiacp.com/docs/reference/cli.html#v-update-sys-hestia-all "v-update-sys-hestia-all")
- [v-update-sys-hestia-git](https://hestiacp.com/docs/reference/cli.html#v-update-sys-hestia-git "v-update-sys-hestia-git")
- [v-update-sys-ip](https://hestiacp.com/docs/reference/cli.html#v-update-sys-ip "v-update-sys-ip")
- [v-update-sys-ip-counters](https://hestiacp.com/docs/reference/cli.html#v-update-sys-ip-counters "v-update-sys-ip-counters")
- [v-update-sys-queue](https://hestiacp.com/docs/reference/cli.html#v-update-sys-queue "v-update-sys-queue")
- [v-update-sys-rrd](https://hestiacp.com/docs/reference/cli.html#v-update-sys-rrd "v-update-sys-rrd")
- [v-update-sys-rrd-apache2](https://hestiacp.com/docs/reference/cli.html#v-update-sys-rrd-apache2 "v-update-sys-rrd-apache2")
- [v-update-sys-rrd-ftp](https://hestiacp.com/docs/reference/cli.html#v-update-sys-rrd-ftp "v-update-sys-rrd-ftp")
- [v-update-sys-rrd-httpd](https://hestiacp.com/docs/reference/cli.html#v-update-sys-rrd-httpd "v-update-sys-rrd-httpd")
- [v-update-sys-rrd-la](https://hestiacp.com/docs/reference/cli.html#v-update-sys-rrd-la "v-update-sys-rrd-la")
- [v-update-sys-rrd-mail](https://hestiacp.com/docs/reference/cli.html#v-update-sys-rrd-mail "v-update-sys-rrd-mail")
- [v-update-sys-rrd-mem](https://hestiacp.com/docs/reference/cli.html#v-update-sys-rrd-mem "v-update-sys-rrd-mem")
- [v-update-sys-rrd-mysql](https://hestiacp.com/docs/reference/cli.html#v-update-sys-rrd-mysql "v-update-sys-rrd-mysql")
- [v-update-sys-rrd-net](https://hestiacp.com/docs/reference/cli.html#v-update-sys-rrd-net "v-update-sys-rrd-net")
- [v-update-sys-rrd-nginx](https://hestiacp.com/docs/reference/cli.html#v-update-sys-rrd-nginx "v-update-sys-rrd-nginx")
- [v-update-sys-rrd-pgsql](https://hestiacp.com/docs/reference/cli.html#v-update-sys-rrd-pgsql "v-update-sys-rrd-pgsql")
- [v-update-sys-rrd-ssh](https://hestiacp.com/docs/reference/cli.html#v-update-sys-rrd-ssh "v-update-sys-rrd-ssh")
- [v-update-user-backup-exclusions](https://hestiacp.com/docs/reference/cli.html#v-update-user-backup-exclusions "v-update-user-backup-exclusions")
- [v-update-user-counters](https://hestiacp.com/docs/reference/cli.html#v-update-user-counters "v-update-user-counters")
- [v-update-user-disk](https://hestiacp.com/docs/reference/cli.html#v-update-user-disk "v-update-user-disk")
- [v-update-user-package](https://hestiacp.com/docs/reference/cli.html#v-update-user-package "v-update-user-package")
- [v-update-user-quota](https://hestiacp.com/docs/reference/cli.html#v-update-user-quota "v-update-user-quota")
- [v-update-user-stats](https://hestiacp.com/docs/reference/cli.html#v-update-user-stats "v-update-user-stats")
- [v-update-web-domain-disk](https://hestiacp.com/docs/reference/cli.html#v-update-web-domain-disk "v-update-web-domain-disk")
- [v-update-web-domain-ssl](https://hestiacp.com/docs/reference/cli.html#v-update-web-domain-ssl "v-update-web-domain-ssl")
- [v-update-web-domain-stat](https://hestiacp.com/docs/reference/cli.html#v-update-web-domain-stat "v-update-web-domain-stat")
- [v-update-web-domain-traff](https://hestiacp.com/docs/reference/cli.html#v-update-web-domain-traff "v-update-web-domain-traff")
- [v-update-web-domains-disk](https://hestiacp.com/docs/reference/cli.html#v-update-web-domains-disk "v-update-web-domains-disk")
- [v-update-web-domains-stat](https://hestiacp.com/docs/reference/cli.html#v-update-web-domains-stat "v-update-web-domains-stat")
- [v-update-web-domains-traff](https://hestiacp.com/docs/reference/cli.html#v-update-web-domains-traff "v-update-web-domains-traff")
- [v-update-web-templates](https://hestiacp.com/docs/reference/cli.html#v-update-web-templates "v-update-web-templates")
- [v-update-white-label-logo](https://hestiacp.com/docs/reference/cli.html#v-update-white-label-logo "v-update-white-label-logo")
</details>
...
Based on sk-import-cpanel-backup-to-vestacp Credits: Maks Usmanov (skamasle) and contributors: Thanks to [https://github.com/Skamasle/sk-import-cpanel-backup-to-vestacp/graphs/contributors](https://github.com/Skamasle/sk-import-cpanel-backup-to-vestacp/graphs/contributors)
...
This function searches for available Hestia Control Panel commands and returns results based on the specified criteria. Originally developed for VestaCP by Federico Krum [https://github.com/FastDigitalOceanDroplets/VestaCP/blob/master/files/v-search-command](https://github.com/FastDigitalOceanDroplets/VestaCP/blob/master/files/v-search-command)
